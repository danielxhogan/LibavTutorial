  ...
  SwsOutputContext *sws_out_ctx)
{
  ...
  if ((ret =
    avcodec_send_frame(out_ctx->enc_ctx, sws_out_ctx->scaled_frame)) < 0)
  {
  ...
  SwsOutputContext *sws_out_ctx)
{
  ...
  while ((ret = avcodec_receive_frame(in_ctx->dec_ctx, in_ctx->dec_frame)) >= 0)
  {
    ...
    if ((ret = encode_frame(in_ctx, in_stream,
      out_ctx, out_stream, sws_out_ctx)) < 0)
    {
...
int main(int argc, char **argv)
{
  ...
  if ((ret =
    transcode(in_ctx, in_stream, out_ctx, out_stream, sws_out_ctx)) < 0)
  {
  ...
  in_ctx->init_pkt = NULL;
  if ((ret =
    decode_packet(in_ctx, in_stream, out_ctx, out_stream, sws_out_ctx)) < 0)
  {
  ...
  sws_out_ctx->scaled_frame = NULL;
  if ((ret =
    encode_frame(in_ctx, in_stream, out_ctx, out_stream, sws_out_ctx)) < 0)
  {
