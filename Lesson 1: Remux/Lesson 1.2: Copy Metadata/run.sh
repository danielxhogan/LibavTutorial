# All metadata, side data, and chapters are copied.
...
# All stream metadata is copied. Ogg does not support file metadata, side data, or traditional chapters.
# cd build && ninja && ./cpmetadata "../videos/inputs/theora_vorbis.mkv" "../videos/outputs/theora_vorbis.ogg" "theora_vorbis.ogg"

# Chapters and side data are copied but only supported metadata values are included. Stream title not supported in mp4.
...
# Chapters and file metadata are copied. Except for language, stream metadata and side data is not supported in wmv.
# cd build && ninja && ./cpmetadata "../videos/inputs/av1_mp3.mp4" "../videos/outputs/av1_mp3.wmv" "av1_mp3.wmv"

# Only file title is copied. Chapters and side data are not supported in avi
...
# File metadata is copied. Side data is copied and also set as file metadata. Chapters and stream metadata is not supported in flv.
