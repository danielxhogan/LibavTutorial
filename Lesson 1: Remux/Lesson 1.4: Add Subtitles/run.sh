...
# cd build && ninja && ./addsubs "../videos/inputs/theora_vorbis.ogg" "../subtitles.vtt" "../videos/outputs/theora_vorbis.ogg" "theora_vorbis.ogg"
# cd build && ninja && ./addsubs "../videos/inputs/h264_mp3.flv" "../subtitles.vtt" "../videos/outputs/h264_mp3.flv" "h264_mp3.flv"
